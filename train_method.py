...
from utils import dice_eval, adjust_learning_rate, loss_calc, bce_loss, decode_seg_map_sequence
from loss import dice_loss
from evaluation import eval_during_train
...
def train_supervised(model, train_loader, val_loader, args):
    ...
    if args.optimizer == 'Adam':
        ...
        optimizer = optim.SGD(model.optim_paramters(args.learning_rate),
    ...
    for i_iter in tqdm(range(args.max_iters + 1)):
        ...
        if i_iter % 200 == 0 and i_iter != 0:
            ...
            iter_eval_supervised(model, images_val, labels_val, args)